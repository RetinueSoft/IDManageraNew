enum UserRole {
  ...
  static UserRole fromInt(int value) =>
      value >= 0 && value < UserRole.values.length ? UserRole.values[value] : UserRole.unknown;
...
enum LayerFieldType {
  ...
  static LayerFieldType fromInt(int value) => value == 2 ? LayerFieldType.image : LayerFieldType.text;
