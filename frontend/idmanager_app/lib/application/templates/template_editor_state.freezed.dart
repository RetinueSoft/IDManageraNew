...
/// combined view it is the side of the layer last clicked.
 ...
 bool get combined; String? get selectedGroupId; bool get isSaving;
...
int get hashCode {
  final _this = this as TemplateEditorState;
  return Object.hash(runtimeType,_this.template,const DeepCollectionEquality().hash(_this.layers),const DeepCollectionEquality().hash(_this.sampleFields),_this.side,_this.combined,_this.selectedGroupId,_this.isSaving);
}

@override
String toString() {
  final _this = this as TemplateEditorState;
  return 'TemplateEditorState(template: ${_this.template}, layers: ${_this.layers}, sampleFields: ${_this.sampleFields}, side: ${_this.side}, combined: ${_this.combined}, selectedGroupId: ${_this.selectedGroupId}, isSaving: ${_this.isSaving})';
}
...
@useResult
$Res call({
 CardTemplateDetail template, List<TemplateLayer> layers, List<ExtractedField> sampleFields, CardSide side, bool combined, String? selectedGroupId, bool isSaving
});
...
/// Create a copy of TemplateEditorState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? template = null,Object? layers = null,Object? sampleFields = null,Object? side = null,Object? combined = null,Object? selectedGroupId = freezed,Object? isSaving = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CardTemplateDetail template,  List<TemplateLayer> layers,  List<ExtractedField> sampleFields,  CardSide side,  bool combined,  String? selectedGroupId,  bool isSaving)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TemplateEditorState() when $default != null:
return $default(_that.template,_that.layers,_that.sampleFields,_that.side,_that.combined,_that.selectedGroupId,_that.isSaving);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CardTemplateDetail template,  List<TemplateLayer> layers,  List<ExtractedField> sampleFields,  CardSide side,  bool combined,  String? selectedGroupId,  bool isSaving)  $default,) {final _that = this;
switch (_that) {
case _TemplateEditorState():
return $default(_that.template,_that.layers,_that.sampleFields,_that.side,_that.combined,_that.selectedGroupId,_that.isSaving);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CardTemplateDetail template,  List<TemplateLayer> layers,  List<ExtractedField> sampleFields,  CardSide side,  bool combined,  String? selectedGroupId,  bool isSaving)?  $default,) {final _that = this;
switch (_that) {
case _TemplateEditorState() when $default != null:
return $default(_that.template,_that.layers,_that.sampleFields,_that.side,_that.combined,_that.selectedGroupId,_that.isSaving);case _:
  return null;
...
class _TemplateEditorState implements TemplateEditorState {
  const _TemplateEditorState({required this.template, required  List<TemplateLayer> layers,  List<ExtractedField> sampleFields = const <ExtractedField>[], this.side = CardSide.front, this.combined = true, this.selectedGroupId, this.isSaving = false}): _layers = layers,_sampleFields = sampleFields;
...
@override
int get hashCode {
    return Object.hash(runtimeType,template,const DeepCollectionEquality().hash(_layers),const DeepCollectionEquality().hash(_sampleFields),side,combined,selectedGroupId,isSaving);
}

@override
String toString() {
    return 'TemplateEditorState(template: $template, layers: $layers, sampleFields: $sampleFields, side: $side, combined: $combined, selectedGroupId: $selectedGroupId, isSaving: $isSaving)';
}
...
/// Create a copy of TemplateEditorState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? template = null,Object? layers = null,Object? sampleFields = null,Object? side = null,Object? combined = null,Object? selectedGroupId = freezed,Object? isSaving = null,}) {
